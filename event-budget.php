...
if(isset($_SESSION['eeid'])){
    ...
    if(isset($_POST['update'])){
        ...
        update_event($name,$description,$price,$package_image,$room,$id);
...
<head>
    ...
    <title>Chillaxr | Event Budget</title>
        ...
        <div class="row">
                    ...
                    <div class="box-body">
                        <form role="form" method="POST" enctype="multipart/form-data">
                            <div class="input-group">
                                ...
                                <input type="text" name="event_name" value="<?php if(isset($_GET['id'])){ echo $event['eventbudget_name']; }?>" class="form-control" placeholder="Name" required="required">
                            </div>
                            <br>

                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                <input type="text" name="event_price" value="<?php if(isset($_GET['id'])){ echo $event['eventbudget_price']; }?>" class="form-control" placeholder="Price" required="required">
                            </div>
                            <br />
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-dashboard"></i></span>
                                <input type="text" name="time_range"  class="form-control" placeholder="Time-Range" required="required">
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="room" required="required">
                                  ...
                                  foreach($rooms as $room){?>
                                    <option value="<?php echo $room['roomid'];?>" <?php if((isset($_GET['id'])) && ($_GET['id']==$room['roomid'])){echo "selected='selected'";}?> > <?php echo $room['room_name'];?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <br>
                            <div class="input-group">
                                ...
                                <input type="file" name="package_image"  class="form-control" placeholder="Price">
                            </div>
                            <br>

                            <div class="input-group">
                                <textarea name="event_desc" cols="100" rowsclass="10" class="form-control" value="<?php if((isset($_GET['id']))){ echo $event['eventbudget_description']; }?>" placeholder="Short Description.."><?php if((isset($_GET['id']))){ echo $event['eventbudget_description']; }?></textarea>
                            </div>
                        <br>
                            ...
                            <div>
                                ...
                                if(isset($_GET['id'])){ echo "update";}else{ echo "upload_event"; } ?>" class="btn btn-block btn-primary"><?php
                                        if(isset($_GET['id'])){ echo "Edt";}else{ echo "Save"; } ?></button>
                                <?php
                                    if(isset($_GET['id'])){

                                ?>
                                <a href="event-budget.php" class="btn btn-block btn-danger">Cancel</a>
                                <?php } ?>
                            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="box-header">
                    <h3 class="box-title">Event Budget</h3>
                </div><!-- /.box-header -->
                    <div class="box-body">
                        <!-- THE CALENDAR -->
                        ...
                        <tbody>
                                ...
                                <?php
                                    $events = get_event_budget($_SESSION['eeid']);
                                    foreach($events as $event){
                                        $room_name = get_room($event['roomid']);

                                        ?>
                                <tr>
                                <td align="center"><img src="Images/<?php echo $event['eventbudget_image'];?>" width="50px" height="50px" align="center"></td>
                                <td><?php echo $event['eventbudget_name'];?></td>
                                <td><?php echo $event['eventbudget_description'];?></td>
                                <td><?php echo $event['eventbudget_price'];?></td>
                                <td><?php echo $event['time_range']; ?></td>
                                <td><?php echo $room_name['room_name'];?></td>
                                <td>

                                    <form role="form" method="post">
                                    <a class="btn btn-primary" href="event-budget.php?id=<?php echo $event['eventbudgetid'];?>"><span class="glyphicon glyphicon-edit"></span></a>

                                    <button class="btn btn-danger" type="submit" name="delete" value="<?php echo $event['eventbudgetid'];?>"><span class="glyphicon glyphicon-trash"></span></button>
                                    </form>
