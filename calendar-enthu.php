              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-body">
                        ...
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal"  data-target="#view" style="float: right;">View Availability</button>          
                  </div>      
                </div>
              </div>
            </div>
                            ...
                            <form role="form">
                               ...
                               <!-- <table>
                                    ...
                                    <?php
                                        ...
                                        if ($time!=null) {
                                            for ($i=intval($time['timeopen']); $i < intval($time['timeclose'])  ; $i+=1 ) { 
                                                $tm = $i;
                                                if ($tm>12) {  
                                                    $tm-=12;  
                                                    $good = "PM";
                                                }
                                                echo "<input type='checkbox' name='time' value=".$i." required>".$tm." ".$good." - ".($tm+1)." ".$good."<br/>";
                                            }
                                    if (intval($time['timeclose'])>12) {
                                        $tclose = intval($time['timeclose']) - 12;
                                    }
                                 } ?>
