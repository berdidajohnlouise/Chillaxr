...
<!-- Content Wrapper. Contains page content -->
    ...
    get_seller( $seller['eeid']);
                    ...
                    <thead>
                      <tr>
                        <!--<th>Action</th>-->
                        <th> <?php echo $seller['establishment_name']; ?></th> 
...
<td align="center" valign="center">
     ...
     <a href="../index.php?rec=userrec&id=<?php echo $seller['eeid'];?>">
                         <img  src="../user_files/<?php echo $seller['establishment_name'];?>/profile_pic/<?php echo $seller['establishment_image'];?>" height="200" width="200"/> </a>
