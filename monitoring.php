...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reservation Monitoring</li>
        </ol>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table ">
                            ...
                            <?php
                            $resevations = get_reservation_by_enthu($_SESSION['enthu_id']);
                            foreach ($resevations as $reservation){

                                $name = get_estab_name($reservation['eeid']);
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('g:i A',strtotime('-1 hour',strtotime($reservation['reservation_time'])));?></td>
                                    <td><?php echo $reservation['reservation_timerange'];?></td>
                                    <td><?php echo $status['name'];?></td>
                                    <td><?php echo $reservation['reservation_invoice'];?></td>
                                    <td><?php echo ucfirst($reservation['room_name']);?></td>
                                    <td><?php
                                          if($reservation['eventid']==0){
                                            echo 'No Package';
                                          }
                                          else{
                                            echo $reservation['eventbudget_name'];
                                          }
                                        ?>
                                  </td>
