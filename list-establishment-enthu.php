              ...
              <?php foreach($establishment as $esh){?>
                ...
                <div  class="col-md-3"  style="margin-top:5px;">
                      ...
                      <div class="thumbnail">
                        ...
                        <a href="establishment-enthu.php?id=<?php echo $esh['mem_id'];?>" target="_blank" >
                          <img  src="user_files/<?php echo $esh['name'];?>/profile_pic/<?php echo $esh['image'];?>" >
                        </a>
                        <div class="esh">
                         <a href="establishment-enthu.php?id=<?php echo $esh['mem_id'];?>" style="text-decoration: none;" target="_blank"><h4><?php echo $esh['name'];?></h4> </a>
